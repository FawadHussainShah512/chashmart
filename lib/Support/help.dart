  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            const Text('Support Center', style: TextStyle(color: Colors.white)),
        leading: IconButton(
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/support/help.webp'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
              ...
              onPressed: () async {
                try {
                  const dynamic conversationObject = {
                    'appId': '143f4a5943fe1b976540bec7418449a3d',
                  };
                ...
                if (currentUser != null) {
                  ...
                  String currentUserName =
                      userSnapshot.get('name') ?? 'Default Name';
