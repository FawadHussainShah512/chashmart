  ...
  void _submitReview(String review, double rating) async {
    try {
      ...
      if (currentUser != null) {
        ...
        _showDialog(
            'Review Submitted', 'Thank you for submitting your review!');
      } else {
        _showDialog('Error',
            'There was an error submitting your review. Please try again later. User is null.');
      }
    } catch (error) {
